                              ...
                              google::protobuf::Message *response, google::protobuf::Closure *done)
{
    ...
    // 使用简单的tcp编程(仅是客户端去调用，不涉及高并发)，完成rpc方法的远程调用：
    ...
    // RPC调用方法想调用service_name的method_name，需要在ZK上去查询该服务所咋的host信息：

    ZkClient zkCli;
    zkCli.Start();
    // 组装好的method_name为：/UserSeviceRpc/Login
    std::string method_path = "/" + service_name + "/" + method_name;
    // 得到的host_data为127.0.0.1：8000
